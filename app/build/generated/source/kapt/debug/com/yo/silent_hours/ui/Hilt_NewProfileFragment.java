 ...
 */
public abstract class Hilt_NewProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewProfileFragment() {
    super();
  }

  Hilt_NewProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewProfileFragment_GeneratedInjector) this.generatedComponent()).injectNewProfileFragment(UnsafeCasts.<NewProfileFragment>unsafeCast(this));
    }
  }
